...
Complessivamente sono stati distribuiti {int(tot_dosi_somministrate)} vaccini (circa il {round(percentuale_somministrazione_su_tot_popolazione,4)*100}% della popolazione è attualmente vaccinata).
    """
    return resume
...
_({round(percentuale_somministrazione_su_tot_popolazione,3)*100}% degli abitanti è attualmente vaccinato)_
    """
    return resume
