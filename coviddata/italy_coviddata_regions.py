...
🚑 Attuali in terapia intensiva {int(self.df_region['terapia_intensiva'].values[-1])}
🚑 Nuovi ingressi in terapia inensiva {int(self.df_region['ingressi_terapia_intensiva'].values[-1])}
